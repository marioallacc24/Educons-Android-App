...
public class RasporedNastavaIT extends AppCompatActivity {

    String url = "https://my-json-server.typicode.com/marioallacc24/educonsapi/nastava";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_raspored_nastava_it);
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    ...
                    Toast.makeText(RasporedNastavaIT.this,"JSON greska!",Toast.LENGTH_SHORT).show();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(RasporedNastavaIT.this,"Greska pri ucitavanju!",Toast.LENGTH_SHORT).show();
            }
        });
